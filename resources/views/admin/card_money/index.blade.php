...
<div class="row">
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <a class="btn btn-default " href="{{url('admin/card_money/create')}}" role="button">
                      <i class="fa fa-plus"></i> เพิ่มบัตรเติมเงิน</a>
                ...
                @foreach($objs as $u)
                    <tr>
                      <td>{{$u->name_card}}</td>
                      <td>{{$u->money_card_sum}}</td>
                      <td>{{$u->card_point}}</td>

                      <td>

                        <a style="float:left; margin:3px;" class="btn btn-primary btn-xs" href="{{url('admin/card_money/'.$u->id.'/edit')}}" role="button"><i class="fa fa-wrench"></i> </a>

                          <form  action="{{url('admin/card_money/'.$u->id)}}" method="post" onsubmit="return(confirm('Do you want Delete'))">
